...
## 1. Plan and R Mode equirements
- Enter plan mode for any non-trivial task (3+ steps or architectural decisions).
- If something goes wrong, stop and re-plan immediately; do not persist.
- Use plan mode for verification steps, not just building.
- Write detailed requirement specs upfront to reduce ambiguity.
